...
const serviceName = "message_producer"
const defaultServicePort = 3002
...
func setupQueueProducer(ch *amqp.Channel, exchangeName string, bindingKey string) (<-chan amqp.Delivery, error) {
